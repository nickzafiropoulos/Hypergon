...
export const BOSS_ROSTER: BossDef[] = [
  {
    id: 'prism',
    name: 'PRISM WARDEN',
    blurb: 'flank or pierce with RAIL',
    r: 64,
    hp: 220,
    col: '#c9b4ff',
    spd: 42,
  ...
  },
  {
    id: 'crown',
    name: 'ORBITAL CROWN',
    blurb: 'shatter the satellites first',
    r: 48,
    hp: 180,
    col: '#ffb02e',
    spd: 28,
  ...
  },
  {
    id: 'void_anchor',
    name: 'VOID ANCHOR',
    blurb: 'lure it into the edge spikes',
    r: 72,
    hp: 260,
    col: '#ff2d55',
    spd: 18,
  ...
  },
  {
    id: 'hexstorm',
    name: 'HEXSTORM',
    blurb: 'kite it through its own mines',
    r: 58,
    hp: 200,
    col: '#b8ff3d',
    spd: 55,
  ...
  },
  {
    id: 'aegis_titan',
    name: 'AEGIS TITAN',
    blurb: 'RAIL pierces · bomb peels plates',
    r: 78,
    hp: 280,
    col: '#ff7a3d',
    spd: 36,
  ...
  },
  {
    id: 'serpent_regent',
    name: 'SERPENT REGENT',
    blurb: 'only the head takes damage',
    r: 36,
    hp: 240,
    col: '#4dffc3',
    spd: 95,
  ...
  },
  {
    id: 'phase_lattice',
    name: 'PHASE LATTICE',
    blurb: 'hit it while solid · STASIS helps',
    r: 68,
    hp: 230,
    col: '#a98bff',
    spd: 40,
  ...
  },
  {
    id: 'starforge',
    name: 'STARFORGE',
    blurb: 'destroy the vents to slow the forge',
    r: 70,
    hp: 300,
    col: '#ff3fa4',
    spd: 22,
  ...
  },
  {
    id: 'crystal_nexus',
    name: 'CRYSTAL NEXUS',
    blurb: 'break the healing crystals',
    r: 66,
    hp: 250,
    col: '#9ee9ff',
    spd: 30,
  ...
  },
  {
    id: 'pulse_maw',
    name: 'PULSE MAW',
    blurb: 'unload when the maw opens',
    r: 80,
    hp: 320,
    col: '#ff2d55',
    spd: 26,
  ...
  },
  {
    id: 'grid_reaver',
    name: 'GRID REAVER',
    blurb: 'strike in the recovery window',
    r: 74,
    hp: 290,
    col: '#ffb02e',
    spd: 50,
  ...
  },
  {
    id: 'twin_helix',
    name: 'TWIN HELIX',
    blurb: 'pressure both or they regenerate',
    r: 44,
    hp: 340,
    col: '#b8ff3d',
    spd: 60,
  ...
  },
  {
    ...
    blurb: 'LODESTONE reverses the pull',
    r: 76,
    hp: 310,
    col: '#b8ff3d',
    spd: 24,
  ...
  },
  {
    id: 'arc_throne',
    name: 'ARC THRONE',
    blurb: 'ARC through the minion ring',
    r: 70,
    hp: 300,
    col: '#a98bff',
    spd: 20,
  ...
  },
  {
    id: 'railbait',
    name: 'RAILBAIT',
    blurb: 'RAIL the telegraph for a crit',
    r: 50,
    hp: 260,
    col: '#9ee9ff',
    spd: 140,
  ...
  },
  {
    id: 'nest_queen',
    name: 'NEST QUEEN',
    blurb: 'burn the nests · she weakens while nesting',
    r: 68,
    hp: 330,
    col: '#ffd98a',
    spd: 34,
  ...
  },
  {
    id: 'stasis_warden',
    name: 'STASIS WARDEN',
    blurb: 'bait it into its own freeze zones',
    r: 62,
    hp: 300,
    col: '#a98bff',
    spd: 70,
  ...
  },
  {
    ...
    blurb: 'bombs peel armor · then shatter the core',
    r: 92,
    hp: 400,
    col: '#ff7a3d',
    spd: 28,
